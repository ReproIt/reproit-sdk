...
class ProcessorCaptureConformance(unittest.TestCase):
    ...
    def test_the_embedded_tables_match_the_pinned_contract(self) -> None:
    ...
    def test_auxv_parsing_reads_hwcap_and_stops_at_the_terminator(self) -> None:
    ...
    def test_unknown_flags_are_ignored_and_output_is_sorted_unique(self) -> None:
        derived = derive_capabilities(
