...
def capture_processor_capabilities() -> list[str]:
    """Return sorted processor capability strings for this Linux process."""
...
def derive_capabilities(machine: str, cpuinfo: str, hwcap: int | None) -> list[str]:
    """Derive capabilities from bounded raw processor views."""
...
def parse_auxv_hwcap(auxv: bytes) -> int | None:
    """Extract AT_HWCAP from little-endian 64-bit auxiliary vector entries."""
